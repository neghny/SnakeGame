...
public class Ligne implements IForme {
    ...
    public boolean percute(Objet self, Objet other) {
        ...
        if (of.getClass().equals(Ligne.class))
            return IForme.percuteLigneLigne(self.getXposition(), self.getYposition(), self.getXposition() + l, self.getYposition() + h, other.getXposition(), other.getYposition(), other.getXposition() + of.avoirLong(), other.getYposition() + of.avoirHaut());
